			...
			<div id='main'>
				...
				if(isset($kode)){
					...
					if($query){
						?>
						<table>
							<tr><td width="180px"><b> Id. User </b></td><td width="5px"> : </td>
							<td> <?php echo "$row[id_admin]"; ?> </td></tr>
							<tr><td width="180px"><b> Username </b></td><td width="5px"> : </td>
							<td> <?php echo "$row[username]"; ?> </td></tr>
							<tr><td width="180px"><b> Password </b></td><td width="5px"> : </td>
							<td> <?php echo "$row[password]"; ?> </td></tr>
							<tr><td width="180px"><b> Level </b></td><td width="5px"> : </td>
